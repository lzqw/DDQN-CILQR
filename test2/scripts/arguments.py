...
def add_arguments(parser):
    ...
    parser.add_argument('--w_vel', type=float, default=0.20, help="Velocity cost")
    ...
    """myself"""
    parser.add_argument('--q1_lane', type=float, default=1.00, help="Barrier function q1, lane")
    parser.add_argument('--q2_lane', type=float, default=10.00, help="Barrier function q2, lane")
